...
class KNearestNeighbor(object):
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            ##broadcast
            #X[i] - self.X_train->shape(5000,3072)
    ...
    def compute_distances_no_loops(self, X):
        ...
        ##参考https://blog.csdn.net/geekmanong/article/details/51524402
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in range(num_test):
            ...
            # dist = dist[i]
            # idx = np.argsort(dist)
            # closest_y = [self.y_train[x] for x in idx][:k]
            ...
            # _y_pred = count.most_common(1)  #[(0,4)]
